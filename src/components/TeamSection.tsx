            ...
            <div className="max-w-[1280px] mx-auto px-6">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-[#a0aec0] max-w-2xl mx-auto">
                        Meet the people behind our AI-driven mission to deliver world-class
                        solutions.
                    </p>
                </div>
                ...
                <div className="relative max-w-5xl mx-auto">
                    <div className="grid md:grid-cols-3 gap-8">
                        {teamMembers.map((member, index) => (
                            <div
                                key={index}
                                className="bg-[#151b28]/60 backdrop-blur-md border border-[#1f2937] rounded-xl transition-all duration-300 hover:border-[#3b82f6]/30 hover:shadow-[0_0_20px_rgba(59,130,246,0.3)] overflow-hidden group"
                            >
                ...
                <div className="mt-16 text-center">
                    <h3 className="text-2xl font-bold mb-4">
                        Powering Operations with smart
                        <br />
